...
## Prontuário estruturado — registros de sessão (incluído, 1º bloco)
Migration `supabase/migrations/0006_session_records.sql`. Na ficha do paciente
(`/painel/pacientes/[id]`): **financeiro individual do paciente** e **registros de sessão**
com os domínios humor, risco (autolesão/suicídio), medicação, sono, alimentação, saúde
física, mobilidade, saúde social e observações gerais. Confidencial — só o profissional
